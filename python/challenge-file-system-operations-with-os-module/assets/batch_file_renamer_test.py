...
class TestBatchFileRenamer(unittest.TestCase):
    ...
    def test_batch_rename_files(self):
        old_ext = ".txt"
        new_ext = ".md"
        renamed_count, new_file_paths = batch_rename_files(self.test_dir, old_ext, new_ext)
        
        expected_files = [os.path.join(self.test_dir, "file1.md"), os.path.join(self.test_dir, "file2.md")]
