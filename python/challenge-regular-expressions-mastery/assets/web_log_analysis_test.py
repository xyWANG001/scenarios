...
class TestWebLogAnalysis(unittest.TestCase):
    ...
    def test_parse_log_file(self):
        with open('sample_log.txt', 'w', encoding='utf-8') as sample_file:
            sample_file.write('127.0.0.1 - - [26/Apr/2023:16:00:00 +0000] "GET /index.html HTTP/1.1" 200 1024 "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"\n')
            sample_file.write('127.0.0.2 - - [26/Apr/2023:16:01:00 +0000] "POST /login HTTP/1.1" 200 512 "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"\n')
    ...
    def test_analyze_log_entries(self):
        ...
        self.assertEqual(analysis['user_agents']['Mozilla/5.0 (Windows NT 10.0; Win64; x64)'], 3)
